          ...
          <div className='mx-auto font-ibm-plex-sans grid grid-cols-1 md:grid-cols-2 gap-[24px]'>
            ...
            <div className='space-y-5.5 font-ibm-plex-sans flex flex-col justify-center'>
              <h1 className='text-3xl lg:text-[40px] text-left font-normal font-hanuman text-white leading-tight transition-all duration-300'>
                Transforming Healthcare with <br className='hidden md:block' />{' '}
                AI Health Assistant
              </h1>
              <div className='space-y-7.5'>
                <p className='text-sm lg:text-base font-normal leading-[21px] text-[#c0c0c0]'>
                  ...
                  by analyzing patient health based on medical history,
                  symptoms, and consultations. It also provides virtual
                  consultations and well-being advice, making healthcare more
                  accessible and smarter.
                </p>
                <p className='text-sm lg:text-base font-normal leading-[21px] text-[#c0c0c0]'>
                  Our AI health assistant app takes healthcare to the next level
                  by analyzing patient health based on medical history,
          ...
          <div className='mx-auto relative font-ibm-plex-sans flex flex-col md:flex-row gap-[40px] md:gap-0'>
            <div className='md:w-1/2 pr-0 md:pr-5 space-y-4 md:space-y-5.5'>
              ...
              <p className='text-sm lg:text-base font-normal leading-[21px] text-[#c0c0c0]'>
                ...
                assessments and streamline data management with an AI-driven
                assistant. The goal was to create a smart system that could
                assess health risks based on symptoms and medical history while
                offering virtual consultations and personalized well-being
                suggestions.
              </p>
            </div>
              ...
              {solutionList?.map((item, index) => (
                <div key={index} className='space-y-4'>
                  ...
                  <p className='text-[16px] font-normal leading-normal text-white'>
                    Free symptom and report analysis for users.
                  </p>
                </div>
              ))}
            </div>
