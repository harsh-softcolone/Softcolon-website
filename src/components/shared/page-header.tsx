...
const PageHeader = ({ title, breadcrumbItems }: PageHeaderProps) => {
  return (
    <div className='relative overflow-x-hidden flex items-center justify-center'>
      <div className='absolute top-4/6 sm:top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center z-20 gap-2 sm:gap-5'>
        <h1 className='text-white text-3xl sm:text-6xl transition-all duration-300 font-bold leading-normal font-hanuman'>
          {title}
        </h1>
